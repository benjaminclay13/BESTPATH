<%@ Page Title="Create Administrator" Language="C#" MasterPageFile="~/PL/Site.Master" AutoEventWireup="true" CodeBehind="CreateAdministrator.aspx.cs" Inherits="BESTPATH._CreateAdministrator" %>
    ...
    <div class="body">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlRole" runat="server" Height="24px" Width="65%" Font-Bold="True" Font-Size="Large" ForeColor="Black">
            ...
            <tr>
                ...
                <td><asp:DropDownList ID="ddlCounselor" runat="server" Height="24px" Width="65%" Font-Bold="True" Font-Size="Large" ForeColor="Black"></asp:DropDownList></td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>
            </tr>
            ...
            <tr>
                <td class="auto-style1"></td>
                <td><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSecurityQuestion" ErrorMessage="Required" Font-Bold="True" Font-Size="Large" ForeColor="Red" SetFocusOnError="True">Required</asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td class="auto-style1">&nbsp;</td>
                <td>&nbsp;</td>
